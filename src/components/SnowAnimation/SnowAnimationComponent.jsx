...
import { optionsDefaultValue, SnowAnimation } from "./SnowAnimation";
import SnowAnimationControls from "./SnowAnimationControls";
...
function SnowAnimationComponent() {
    ...
    const { id, start, setStart, options, setOptions } = useAnimation(canvasRef, SnowAnimation);
    ...
    return (<div className="SnowAnimationComponent">
            ...
            <Row className="Controls p-0 m-0">
                ...
                <Col className="p-2 m-0" xs={12} xl={6}>
                    <div className="p-2 rounded d-flex justify-content-evenly align-items-center" style={{backgroundColor: '#324897'}}>
                        ...
                        <SnowAnimationControls initialValues={optionsDefaultValue} onChange={changeOptions} />
...
export default SnowAnimationComponent;